...
function App() {
  return (
    <div className="dark w-[screen] dark:text-white  lg:text-textTheme font-montserrat h-screen overflow-x-hidden">
      ...
      <div className="w-full min-h-[80%] lg:min-h-fit mt-64 lg:mt-16 flex flex-col bg-[#f5f5f5]">
        <Footer/>
      </div>
    </div>
  );
