...
export const IndustryCard = ({industry}) => {
  return (
    <>
        <div className="group text-white flex flex-col justify-end px-6 w-[320px] h-[270px] lg:w-[280px] lg:h-[230px] lg:hover:scale-105 bg-black/70 bg-cover rounded-2xl shadow-xl opacity-90 bg-blend-darken transition-all duration-500 ease-linear my-6 cursor-pointer" 
            style={{
