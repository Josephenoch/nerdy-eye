  ...
  return (
    <>
        ...
        <form className="w-[85%] lg:w-1/2 h-full mx-auto lg:p-24 " onSubmit={(e)=>handleSubmit(e)}>
            ...
            <p className="text-xs font-semibold mb-10 text-center"> Thank you for showing interest in the Nerdy Eye's Recruitment Program. Please fill the form below and we will connect you with your ideal employers as soon as possible.</p>
            <div className="lg:pr-20 space-y-8">
                <div className="flex flex-col space-y-5">
                    ...
                    <input type="text" name="" id="role" className="bg-[#f5f5f5] p-5 lg:p-3 focus:outline-none" />
                </div>
                <div className="flex flex-col space-y-5">
